...
<div class="container">
    <div class="row">
        <div class="col-12">
           <h4>MEDICOS - <span class="verde">EDITAR</span></h4>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-sm-6">
             <form method="POST" action="/medicos/{{$medico->id}}">
                 ...
                 @csrf
                 <table>
                     <tr><td align="right">Rut:&nbsp;</td><td><input type="text" name="rut"  id="rut" value="{{$medico->rut}}"></td></tr>
                     <tr><td align="right">Nombre:&nbsp;</td><td><input type="text" name="nombre"  id="nombre" value="{{$medico->nombre}}"></td></tr>
                     <tr><td align="right">Especialidad:&nbsp;</td><td><input type="text" name="especialidad"  id="especialidad" value="{{$medico->especialidad}}"></td></tr>
                     <tr><td></td><td><button type="submit" class="btn btn-secondary">Guardar</button><a class="btn btn-primary" href="{{route('medicos.index')}}" role="button">Cancelar</a></td></tr>
                </table>
            </form>
        </div>
        <div class="col-sm-6">
