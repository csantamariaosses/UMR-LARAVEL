...
<div class="container">
    <div class="row">
        <div class="col-12">
           <h4>PROCEDIMIENTOS - <span class="verde">EDITAR</span></h4>
        </div>
    </div>
    
    <div class="row mt-4">
        <div class="col-sm-6">
             <form method="POST" action="/procedimientos/{{$procedimiento->id}}">
                 @method("PUT")
                 @csrf
                 <table>
                     <tr><td align="right">Id:&nbsp;</td><td><input type="text" name="id"  id="id" value="{{$procedimiento->nombre}}"></td></tr>
                     <tr><td align="right">Nombre:&nbsp;</td><td><input type="text" name="nombre"  id="nombre" value="{{$procedimiento->nombre}}"></td></tr>
                     <tr><td></td><td><button type="submit" class="btn btn-secondary">Guardar</button><a class="btn btn-primary" href="{{route('procedimientos.index')}}" role="button">Cancelar</a></td></tr>
                </table>
            </form>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-sm-12 justify-content-left">
            @if( count( $procedimientos) >0 )    
                ...
                <tr>
                    ...
                    <td>
                     <div>
                    <a href="/medicos/{{$procedimiento->id}}" class="btn btn-info">Editar</a>  
